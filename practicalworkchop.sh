...
gpg --output doc_no_cifrado_firmado.txt --clearsign doc_no_cifrado.txtecho "Hola que hace" > doc_no_cifrado.txt   #"Muestra con echo el mensaje, y lo crea en un documento nuevo"
...
gpg --verify doc_no_cifrado_firmado_Arthur.txt
$ gpg --output doc_no_cifrado_firmado_binario.txt --sign
doc_no_cifrado.txt